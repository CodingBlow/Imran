...
import logo from '../../assets/all-images/RO.jpg'; // Your website logo
      ...
      <div style={styles.container}>
        ...
        <ul style={styles.navMenu}>
          {navLinks.map((link, index) => (
            <li key={index} style={{ textAlign: 'center', backgroundColor: 'transparent' }}> 
              <Link
                to={link.path}
        ...
        {/* WhatsApp Button */}
        <a href="https://wa.me/YOUR_PHONE_NUMBER" target="_blank" rel="noopener noreferrer" style={styles.whatsappButton}>
